 ...
 */
final class Version20221102180501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evento (id INT NOT NULL, nombre VARCHAR(255) NOT NULL, tematica VARCHAR(255) NOT NULL, fecha_ini TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, fecha_fin TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, hora_inic TIME(0) WITHOUT TIME ZONE NOT NULL, hora_fin TIME(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
